...
class VlanID(models_v2.model_base.BASEV2, L2NetworkBaseV2):
...
class VlanBinding(models_v2.model_base.BASEV2, L2NetworkBaseV2):
...
class PortProfile(models_v2.model_base.BASEV2, L2NetworkBaseV2):
...
class PortProfileBinding(models_v2.model_base.BASEV2, L2NetworkBaseV2):
...
class QoS(models_v2.model_base.BASEV2, L2NetworkBaseV2):
...
class Credential(models_v2.model_base.BASEV2, L2NetworkBaseV2):
